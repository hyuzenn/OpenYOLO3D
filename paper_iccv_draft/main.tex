...
\title{Bought, Not Added: Provisional Emission with Retrospective
Revision for Streaming 3D Perception}
...
\makeatletter
\pdfsavepos\write\@auxout{\string\newlabel{bodyend}{{}{\the\c@page}{\the\pdflastxpos}{}{\the\pdflastypos}}}%
\phantomsection\label{page:bibstart}
\makeatother
