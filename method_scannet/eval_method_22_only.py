"""METHOD_22 (CLIP-image-feature label re-classification) standalone eval.

Mirrors `eval_method_31_only.py` / `eval_method_21_only.py`. Installs only
the METHOD_22 hook before delegating to `run_evaluation.test_pipeline_full`.
"""
