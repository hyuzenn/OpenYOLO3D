...
class RGBDFrame():
  ...
  def load(self, file_handle):
    ...
    self.color_data = file_handle.read(self.color_size_bytes)  # py3: keep bytes (was ''.join over 'c' unpack -> TypeError)
...
class SensorData:
  ...
  def load(self, filename):
    with open(filename, 'rb') as f:
      ...
      self.sensor_name = f.read(strlen).decode('utf-8', 'ignore')  # py3: decode (was ''.join over 'c' unpack -> TypeError)
